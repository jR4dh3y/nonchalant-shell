...
Singleton {
    ...
    Process {
        ...
        command: ["python3", decodeURIComponent(Qt.resolvedUrl("../../scripts/desktop_thumbgen.py").toString().replace("file://", "")), desktopDir, Quickshell.env("HOME") + "/.cache/nonchalant" + "/desktop_thumbnails"]
