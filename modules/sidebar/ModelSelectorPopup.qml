...
Popup {
    ...
    width: Math.min(400, Math.max(240, (parent ? parent.width : 400) - edgeMargin * 2))
    // Height: Header (48) + Spacing (12) + List (5 * 48 = 240) + Padding (8*2)
    height: Math.min(contentItem.implicitHeight + padding * 2, (parent ? parent.height : 600) - edgeMargin * 2)
    padding: 16

    // Center in parent with guaranteed edge inset
