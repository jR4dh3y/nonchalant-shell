...
QtObject {
    ...
    // Main Sections:
    // 0: Network, 1: Bluetooth, 2: Mixer, 3: Effects, 4: Theme, 5: Binds, 6: System, 7: Compositor, 8: Nonchalant
    ...
    readonly property var staticItems: [
        ...
        // Binds > Nonchalant
        { label: "Launcher Keybind", keywords: "app launcher menu shortcut", section: 5, subSection: "", subLabel: "Binds > Nonchalant", icon: Icons.rocket, isIcon: true },
        { label: "Dashboard Keybind", keywords: "widgets dashboard shortcut", section: 5, subSection: "", subLabel: "Binds > Nonchalant", icon: Icons.squaresFour, isIcon: true },
        { label: "Clipboard Keybind", keywords: "copy paste shortcut super v", section: 5, subSection: "", subLabel: "Binds > Nonchalant", icon: Icons.clipboard, isIcon: true },
        { label: "Emoji Keybind", keywords: "picker shortcut super period", section: 5, subSection: "", subLabel: "Binds > Nonchalant", icon: Icons.keyboard, isIcon: true },
        { label: "Tmux Keybind", keywords: "terminal shortcut", section: 5, subSection: "", subLabel: "Binds > Nonchalant", icon: Icons.keyboard, isIcon: true },
        ...
        { label: "Lock Command", keywords: "nonchalant lock screen idle", section: 6, subSection: "idle", subLabel: "System > Idle", icon: Icons.moon, isIcon: true },
        ...
        // Compositor > NiriService > General
        { label: "Border Size", keywords: "width thickness stroke", section: 7, subSection: "general", subLabel: "Compositor > NiriService", icon: Icons.frameCorners, isIcon: true },
        { label: "Window Gaps", keywords: "spacing margin padding", section: 7, subSection: "general", subLabel: "Compositor > NiriService", icon: Icons.squaresFour, isIcon: true },

        // Compositor > NiriService > Colors
        { label: "Border Colors", keywords: "active inactive focus", section: 7, subSection: "colors", subLabel: "Compositor > NiriService", icon: Icons.palette, isIcon: true },

        // Compositor > NiriService > Shadows
        { label: "Shadows Enabled", keywords: "toggle on off", section: 7, subSection: "shadows", subLabel: "Compositor > NiriService", icon: Icons.drop, isIcon: true },
        { label: "Sync Shadow Color", keywords: "match border", section: 7, subSection: "shadows", subLabel: "Compositor > NiriService", icon: Icons.palette, isIcon: true },
        { label: "Sync Shadow Opacity", keywords: "match border alpha", section: 7, subSection: "shadows", subLabel: "Compositor > NiriService", icon: Icons.drop, isIcon: true },
        { label: "Shadow Range", keywords: "blur radius size", section: 7, subSection: "shadows", subLabel: "Compositor > NiriService", icon: Icons.circle, isIcon: true },
        { label: "Shadow Offset", keywords: "position x y move", section: 7, subSection: "shadows", subLabel: "Compositor > NiriService", icon: Icons.arrowsOutSimple, isIcon: true },
        { label: "Shadow Power", keywords: "strength render intensity", section: 7, subSection: "shadows", subLabel: "Compositor > NiriService", icon: Icons.lightning, isIcon: true },
        { label: "Shadow Scale", keywords: "zoom resize", section: 7, subSection: "shadows", subLabel: "Compositor > NiriService", icon: Icons.cornersOut, isIcon: true },

        // Compositor > NiriService > Blur
        { label: "Blur Enabled", keywords: "toggle on off transparency", section: 7, subSection: "blur", subLabel: "Compositor > NiriService", icon: Icons.drop, isIcon: true },
        { label: "Blur Size", keywords: "radius amount", section: 7, subSection: "blur", subLabel: "Compositor > NiriService", icon: Icons.circle, isIcon: true },
        { label: "Blur Passes", keywords: "quality iterations", section: 7, subSection: "blur", subLabel: "Compositor > NiriService", icon: Icons.circle, isIcon: true },
        { label: "Blur Xray", keywords: "transparency see through", section: 7, subSection: "blur", subLabel: "Compositor > NiriService", icon: Icons.drop, isIcon: true },
        { label: "Blur New Optimizations", keywords: "performance speed", section: 7, subSection: "blur", subLabel: "Compositor > NiriService", icon: Icons.lightning, isIcon: true },
        { label: "Blur Ignore Opacity", keywords: "transparency alpha", section: 7, subSection: "blur", subLabel: "Compositor > NiriService", icon: Icons.drop, isIcon: true },
        { label: "Blur Ignorealpha", keywords: "explicit transparency", section: 7, subSection: "blur", subLabel: "Compositor > NiriService", icon: Icons.drop, isIcon: true },
        { label: "Blur Ignorealpha Value", keywords: "threshold amount", section: 7, subSection: "blur", subLabel: "Compositor > NiriService", icon: Icons.drop, isIcon: true },
        { label: "Blur Noise", keywords: "grain texture static", section: 7, subSection: "blur", subLabel: "Compositor > NiriService", icon: Icons.drop, isIcon: true },
        { label: "Blur Contrast", keywords: "intensity difference", section: 7, subSection: "blur", subLabel: "Compositor > NiriService", icon: Icons.drop, isIcon: true },
        { label: "Blur Brightness", keywords: "light dark level", section: 7, subSection: "blur", subLabel: "Compositor > NiriService", icon: Icons.drop, isIcon: true },
        { label: "Blur Vibrancy", keywords: "saturation color", section: 7, subSection: "blur", subLabel: "Compositor > NiriService", icon: Icons.drop, isIcon: true },

        // --- Nonchalant / Shell ---
        { label: "Nonchalant", keywords: "about info credits version shell", section: 8, subSection: "", subLabel: "", icon: Qt.resolvedUrl("../../../../assets/nonchalant/nonchalant-icon.svg"), isIcon: false },

        // Nonchalant > Bar
        { label: "Bar", keywords: "panel taskbar top bottom", section: 8, subSection: "bar", subLabel: "Nonchalant > Bar", icon: Icons.layout, isIcon: true },
        { label: "Bar Position", keywords: "top bottom left right edge", section: 8, subSection: "bar", subLabel: "Nonchalant > Bar", icon: Icons.layout, isIcon: true },
        { label: "Launcher Icon", keywords: "logo symbol path", section: 8, subSection: "bar", subLabel: "Nonchalant > Bar", icon: Icons.layout, isIcon: true },
        { label: "Launcher Icon Tint", keywords: "color theme", section: 8, subSection: "bar", subLabel: "Nonchalant > Bar", icon: Icons.palette, isIcon: true },
        { label: "Launcher Icon Full Tint", keywords: "monochrome color", section: 8, subSection: "bar", subLabel: "Nonchalant > Bar", icon: Icons.palette, isIcon: true },
        { label: "Launcher Icon Size", keywords: "width height pixels", section: 8, subSection: "bar", subLabel: "Nonchalant > Bar", icon: Icons.layout, isIcon: true },
        { label: "Pill Style", keywords: "squished roundness radius bar", section: 8, subSection: "bar", subLabel: "Nonchalant > Bar", icon: Icons.layout, isIcon: true },
        { label: "Firefox Player", keywords: "browser media music", section: 8, subSection: "bar", subLabel: "Nonchalant > Bar", icon: Icons.layout, isIcon: true },
        { label: "Bar Auto-hide", keywords: "autohide hide show reveal", section: 8, subSection: "bar", subLabel: "Nonchalant > Bar", icon: Icons.layout, isIcon: true },
        { label: "Pinned on Startup", keywords: "show visible default", section: 8, subSection: "bar", subLabel: "Nonchalant > Bar", icon: Icons.layout, isIcon: true },
        { label: "Hover to Reveal", keywords: "mouse show hide edge", section: 8, subSection: "bar", subLabel: "Nonchalant > Bar", icon: Icons.layout, isIcon: true },
        { label: "Hover Region Height", keywords: "pixels trigger area", section: 8, subSection: "bar", subLabel: "Nonchalant > Bar", icon: Icons.layout, isIcon: true },
        ...
        { label: "Show App Icons", keywords: "application thumbnail workspace", section: 8, subSection: "workspaces", subLabel: "Nonchalant > Workspaces", icon: Icons.squaresFour, isIcon: true },
        { label: "Always Show Numbers", keywords: "workspace label index", section: 8, subSection: "workspaces", subLabel: "Nonchalant > Workspaces", icon: Icons.squaresFour, isIcon: true },
